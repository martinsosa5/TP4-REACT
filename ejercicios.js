...
/*      
     const contacto = new Contacto('Martin',3863447601);
     const contacto1 = new Contacto('Exequiel',3863447601);
     
     agenda.contactos.push(contacto);
     agenda.contactos.push(contacto1);

     agenda.contactos.forEach(contacto => {
        document.write(`<p><b>Contacto</b> <br>Nombre: ${contacto._nombre} <br> Numero: ${contacto._tel}</p>`);
     }); */
   ...
   /*  class Contacto {
    ...
    const contacto1 = new Contacto('Martin','3863529701');
    const contacto2 = new Contacto('Exequiel','3863529701');
    const contacto3 = new Contacto('Agustin','3863529701');
    const contacto4 = new Contacto('Eneas','3863529701');
    const agenda = []; */

    /* let opc = parseInt(prompt(' MENU \n1) Añadir Contacto \n2) Verificar si existe un contacto \n3) Listar Agenda \n4) Buscar Contacto por Nombre \n5) Eliminar contacto \n6) Mostrar Disponibilidad en la agenda \n7) Salir \n Ingresar una opcion:'));
    opc !== '' && !isNaN(opc) && opc>0 && opc<8 ? menu(opc) : document.write(`<p>*ERROR opcion invalida*</p>`);
